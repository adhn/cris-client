...
<script>
    ...
    export default {
        ...
        computed: {
            companies: {
                get () { return this.$store.getters['interaction/companies'] },
                set (value) { this.$store.commit('interaction/companies',value) }
            },
            title: {
        ...
        watch: {
            dialog(value,oldValue) {
                if(value == true) {
                    ...
                    this.companies = [this.$store.getters['company/id']]
                }
