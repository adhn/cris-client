<template>
    <v-dialog v-model="dialog" fullscreen hide-overlay transition="dialog-bottom-transition">
        ...
        <v-toolbar>
          ...
          <v-toolbar-title>Add new interaction to Event</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-toolbar-items>
...
<script>
    ...
    export default {
        ...
        computed: {
            events: {
                get () { return this.$store.getters['interaction/events'] },
                set (value) { this.$store.commit('interaction/events',value) }
            },
            title: {
        ...
        watch: {
            dialog(value,oldValue) {
                if(value == true) {
                    ...
                    this.events = [this.$store.getters['event/id']]
                }
